...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="bg-white text-black font-sans text-base leading-7 px-6 py-8 md:px-20">
      {/* Title */}
      <h1 className="text-5xl font-bold mb-4">Privacy Policy for Droozi</h1>

      <h2 className="text-4xl font-bold mb-2">Privacy Policy</h2>
      <p className="mb-4">Last updated: November 23, 2024</p>
      ...
      <h2 className="text-3xl font-bold mb-2">Interpretation and Definitions</h2>
      ...
      <h3 className="text-2xl font-bold mb-2">Definitions</h3>
      <p className="mb-4">For the purposes of this Privacy Policy:</p>
      <ul className="list-disc pl-6 mb-4 space-y-2">
        <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
        <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
        <li><strong>Application</strong> refers to Droozi, the software program provided by the Company.</li>
        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Droozi.</li>
      ...
      <h2 className="text-3xl font-bold mb-2">Collecting and Using Your Personal Data</h2>
      <h3 className="text-2xl font-bold mb-2">Types of Data Collected</h3>
      ...
      <h4 className="text-xl font-bold mb-2">Usage Data</h4>
      <p className="mb-4">
      ...
      <h4 className="text-xl font-bold mb-2">Information Collected while Using the Application</h4>
      <p className="mb-4">
      ...
      <h4 className="text-xl font-bold mb-2">Use of Your Personal Data</h4>
      <p className="mb-4">
      ...
      <h4 className="text-xl font-bold mb-2">Sharing Your Personal Information</h4>
      <p className="mb-4">
      ...
      {/* …The rest continues exactly word-for-word like this (Retention, Transfer, Delete, Disclosure, Security, Children’s Privacy, Links, Changes, Contact) */}
      ...
      <p className="mb-4">
        By email: <strong>vshtym@gmail.com</strong>
      </p>
